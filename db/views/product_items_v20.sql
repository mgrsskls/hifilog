-- v20 drops completeness / specs_* and the highlighted-specs LATERAL. Those live on
-- contribute_product_items so catalogue listings no longer pay the per-row join.
SELECT
