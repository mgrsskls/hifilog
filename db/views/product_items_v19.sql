-- v19: `discontinued_year` joins the score, but only for entries that are discontinued.
--
-- v18 added `completeness`: a 0-100 score of how much of an entry has been filled in.
--
